...
const NEXT_PUBLIC_BASE_WEB_DOMAIN_WITH_PROTOCOL = NEXT_PUBLIC_BASE_DOMAIN_WITH_PROTOCOL || 'http://localhost:3000';
const NEXT_PUBLIC_BASE_API_DOMAIN_WITH_PROTOCOL = NEXT_PUBLIC_BASE_DOMAIN_WITH_PROTOCOL || 'http://localhost:4000';
...
exports.NEXT_PUBLIC_BASE_DORMS_WEB_URL = NEXT_PUBLIC_BASE_DOMAIN_WITH_PROTOCOL ? `${exports.NEXT_PUBLIC_BASE_WEB_URL}/dorms` : 'http://localhost:3003'; 
exports.NEXT_PUBLIC_BASE_DORMS_API_URL = NEXT_PUBLIC_BASE_DOMAIN_WITH_PROTOCOL ? `${exports.NEXT_PUBLIC_BASE_API_URL}/dorms` : 'http://localhost:4003'; 