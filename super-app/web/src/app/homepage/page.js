...
import { NEXT_PUBLIC_BASE_WEB_URL, NEXT_PUBLIC_BASE_WEB_PATH } from "../../../config";
export default function Home() {
    return (
        
        <div className={style.bg_page}>
            <div className={style.navbar}>
                <img style={{marginLeft:"53px"}} src={`${NEXT_PUBLIC_BASE_WEB_PATH}/image/DekHor-icon.png`}/>
                <img style={{marginRight:"53px"}} src={`${NEXT_PUBLIC_BASE_WEB_PATH}/image/user-icon.png`}/>
            </div>
            <div className={style.place_holder}>
                <img style={{width:'100vw'}} src={`${NEXT_PUBLIC_BASE_WEB_PATH}/image/place_holder.png`}/>
            </div>
            ...
            <div style={{marginTop:"150px",justifyContent:"space-around",width:'100%',height:'100vh',display:'flex'}}>
                <Link style={{textDecoration:'none'}} href={`${NEXT_PUBLIC_BASE_WEB_URL}/dorms`}>
                    <div className={style.portal}>
                        <div className={style.icon}><img className={style.bg_portal} src={`${NEXT_PUBLIC_BASE_WEB_PATH}/image/dekhordorm_portal.png`}/></div>
                ...
                <Link style={{textDecoration:'none'}} href={`${NEXT_PUBLIC_BASE_WEB_URL}/blogs`}>
                    <div className={style.portal}>
                        <div className={style.icon}><img className={style.bg_portal} src={`${NEXT_PUBLIC_BASE_WEB_PATH}/image/dekhorblog_portal.png`}/></div>
                        <p className={style.subtitle_portal}>DekHor Blogs</p>
                    </div>
                    </Link>
                <Link style={{textDecoration:'none'}} href={`${NEXT_PUBLIC_BASE_WEB_URL}/eats`}>
                    <div className={style.portal}>
                        <div className={style.icon}><img className={style.bg_portal} src={`${NEXT_PUBLIC_BASE_WEB_PATH}/image/dekhoreat_portal.png`}/></div>
