...
export default function Footer() {
    return (
        <div className={styles.footerframe}>
            <Image src="/DekhorlogoTrans.png" width={96} height={96} alt="logo"/>
            <div className={styles.footercontent}> 
                ...
                <div className={styles.footercontactbox}>
                    ...
                    <div className={styles.footercontact}> 
                        <Image src ="/EmailFtico.png" alt = "email" width={20} height={20}/> Email : contact@dekhorsuperapp.bruh </div>
                    <div className={styles.footercontact}>
                        <Image src ="/FBftico.png" alt = "FB" width={20} height={20}/> Facebook : DekHor Super App </div>
                    <div className={styles.footercontact}>
                        <Image src ="/phonecallico.png" alt = "phone" width={20} height={20}/> 02-XXX-XXXX </div>
                </div>
            </div>
