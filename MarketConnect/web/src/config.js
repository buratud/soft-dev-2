...
const REACT_APP_BASE_WEB_DOMAIN_WITH_PROTOCOL = REACT_APP_BASE_DOMAIN_WITH_PROTOCOL || 'http://localhost:3000';
const REACT_APP_BASE_API_DOMAIN_WITH_PROTOCOL = REACT_APP_BASE_DOMAIN_WITH_PROTOCOL || 'http://localhost:5200';
