...
//                     return res.status(400).send();
//                 }
//                 return res.status(200).json({status:"success", message : "Question and concern updated successfully!", results: results})
//             }
//         )
...
//     const {old_theme, new_theme} = req.body
//     try {
//         connection.query(
//             "UPDATE `theme` SET `CHOICE`= ? WHERE `CHOICE`= ?",
